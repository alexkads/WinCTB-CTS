...
namespace WinCTB_CTS.Module.Win.Templates
{
    public partial class DetailRibbonFormTemplate : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IBarManagerHolder, ISupportViewChanged, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IViewHolder
    {
        ...
        public DetailRibbonFormTemplate()
        {
            InitializeComponent();
