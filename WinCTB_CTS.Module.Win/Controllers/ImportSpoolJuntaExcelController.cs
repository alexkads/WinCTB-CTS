        ...
        private void ImportarJuntas(XPObjectSpace objectSpace, DataTable dtJuntasImport, IProgress<ImportProgressReport> progress)
        {
            ...
            for (int i = 0; i < ToalRows; i++)
            {
                ...
                if (spool != null)
                {
                    ...
                    juntaSpool.DiametroMilimetro = Convert.ToDouble(linha["diametroMilimetro"]);
                    ...
                    juntaSpool.DataVa = Convert.ToDateTime(linha["dataVa"]);
                    ...
                    juntaSpool.DataSoldagem = Convert.ToDateTime(linha["dataSoldagem"]);
                    ...
                    juntaSpool.Espessura = Convert.ToDouble(linha["espessura"]);
                    ...
                    juntaSpool.DataDureza = Convert.ToDateTime(linha["dataDureza"]);
                    ...
                    juntaSpool.DataRastMaterial = Convert.ToDateTime(linha["dataRastMaterial"]);
                    juntaSpool.StatusIdLiga = linha["statusIdLiga"].ToString();
                    juntaSpool.InspetorIdLiga = linha["inspetorIdLiga"].ToString();
                    juntaSpool.DataIdLiga = Convert.ToDateTime(linha["dataIdLiga"]);
                    ...
                    juntaSpool.DataRx = Convert.ToDateTime(linha["dataRx"]);
                    ...
                    juntaSpool.DataUs = Convert.ToDateTime(linha["dataUs"]);
                    ...
                    juntaSpool.DataFerrita = Convert.ToDateTime(linha["dataFerrita"]);
                    ...
                    juntaSpool.DataEstanqueidade = Convert.ToDateTime(linha["dataEstanqueidade"]);
                    ...
                    juntaSpool.DataLiberacaoJunta = Convert.ToDateTime(linha["dataLiberacaoJunta"]);
