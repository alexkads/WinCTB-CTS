...
{
    public class ImportContratoEstrutura : CalculatorProcessBase
    {
        public ImportContratoEstrutura(CancellationToken cancellationToken, IProgress<ImportProgressReport> progress)
