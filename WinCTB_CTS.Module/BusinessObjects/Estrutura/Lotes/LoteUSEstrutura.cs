...
{
    [DefaultProperty(nameof(NumeroDoLote)), Persistent("WT_LoteUSEstrutura"), ImageName("BO_Contract"), NavigationItem("Lote")]
    [Appearance("", AppearanceItemType = nameof(Action), TargetItems = "CloneObject, New", Visibility = ViewItemVisibility.Hide)]
    [XafDisplayName("Lote de US Estrutura")]
    [FriendlyKeyProperty(nameof(NumeroDoLote))]
    public class LoteUSEstrutura : XPBaseObject, ILote
    {
        ...
        public LoteUSEstrutura(Session session)
            : base(session)
        {
        }
        ...
        {
            base.OnDeleting();
            new HashSet<LoteUSJuntaEstrutura>(LoteUSjuntaEstruturas)
        ...
        [Association("LoteUSEstrutura-LoteUSjuntaEstruturas"), DevExpress.Xpo.Aggregated]
        public XPCollection<LoteUSJuntaEstrutura> LoteUSjuntaEstruturas => GetCollection<LoteUSJuntaEstrutura>(nameof(LoteUSjuntaEstruturas));
    ...
    public class LoteUSJuntaEstrutura : BaseObject, ILoteDetalhe
    {
        ...
        private LoteUSEstrutura _loteUSEstrutura;
        private string _NumeroDoRelatorio;
        private double _percentualNivelDeInspecao;

        public LoteUSJuntaEstrutura(Session session)
            : base(session) { }
        ...
        [Association("LoteUSEstrutura-LoteUSjuntaEstruturas")]
        public LoteUSEstrutura LoteUSEstrutura
        {
            get => _loteUSEstrutura;
            set => SetPropertyValue(nameof(LoteUSEstrutura), ref _loteUSEstrutura, value);
        }
