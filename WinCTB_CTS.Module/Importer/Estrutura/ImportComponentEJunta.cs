...
namespace WinCTB_CTS.Module.Importer.Estrutura
{
    public class ImportComponentEJunta
    {
        ...
        public void LogTrace(ImportProgressReport value)
        {
            ...
            _parametrosImportComponentEJunta.Progresso = progresso;
            //statusProgess.Text = value.MessageImport;
        }

        public async Task ImportarComponente(DataTable dtSpoolsImport, IProgress<ImportProgressReport> progress)
        {
                    ...
                    .Subscribe(i =>
                        {
                            ...
                            progress.Report(new ImportProgressReport
                            {
                                TotalRows = TotalDeComponentes,
                                CurrentRow = i + 1,
                                MessageImport = $"Importando linha {i}/{TotalDeComponentes}"
                            });
                        });
