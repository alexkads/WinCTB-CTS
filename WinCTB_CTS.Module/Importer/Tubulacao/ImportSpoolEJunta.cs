...
//        //public async Task ImportarSpoolsTeste(DataTable dtSpoolsImport, IProgress<ImportProgressReport> progress)
//        //{
//        //    var tasks = new List<Task>();

//        //    Action<DataRow> processRow = (row) =>
//        //    {
//        //        UnitOfWork uow = new UnitOfWork(providerDataLayer.GetCacheDataLayer());
...
//        //        tasks.Add(Task.Run(() => processRow(row)));
