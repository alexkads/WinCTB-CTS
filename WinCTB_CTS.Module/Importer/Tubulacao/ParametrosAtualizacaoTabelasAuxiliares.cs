...
{
    [ModelDefault("Caption", "Importação DE Tabelas Auxiliares")]
    ...
    public class ParametrosAtualizacaoTabelasAuxiliares : ParametrosImportBase
    {
        public ParametrosAtualizacaoTabelasAuxiliares(Session session) : base(session){}

        public override string NomeDoRecurso { get => "TabelaAuxiliarTubulacao.xlsx"; }
    }
}
